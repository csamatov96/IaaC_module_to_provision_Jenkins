output "jenkins_master" {
  value = " http://${aws_route53_record.jenkins_master.name}:9090"
}

output "worker1" {
  value = " http://${aws_route53_record.jenkins_worker1.name}:9090"
}

output "worker2" {
  value = " http://${aws_route53_record.jenkins_worker2.name}:9090"
}
/*
output "worker3" {
